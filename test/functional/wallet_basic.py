...
class WalletTest(EZ25COINTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 EZC from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 ezc in block rewards plus fees, but
        ...
        # Send 10 EZC with subtract fee from amount
        ...
        # Sendmany 10 EZC with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/ez25coin/ez25coin/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
