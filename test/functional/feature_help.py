...
"""Verify that starting ez25coin with -h works as expected."""

from test_framework.test_framework import EZ25COINTestFramework
from test_framework.util import assert_equal

class HelpTest(EZ25COINTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ez25coin with -h for help text")
        ...
        self.log.info("Start ez25coin with -version for version information")
        ...
        self.log.info("Start ez25coind with -fakearg to make sure it does not start")
