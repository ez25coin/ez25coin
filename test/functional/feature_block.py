...
class FullBlockTest(EZ25COINTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure ez25coind isn't accepting b26
        ...
        # Extend the b28 chain to make sure ez25coind isn't accepting b28
        ...
        # ez25coind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the ez25coin code has custom code which does so);
