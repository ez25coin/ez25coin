...
# TestP2PConn: A peer we use to send messages to ez25coind, and store responses.
...
class CompactBlocksTest(EZ25COINTestFramework):
    ...
    # This test actually causes ez25coind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that ez25coind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for ez25coind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # ez25coind will not send blocktxn responses for blocks whose height is
