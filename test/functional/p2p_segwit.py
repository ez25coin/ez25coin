...
class SegWitTest(EZ25COINTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older ez25coind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let ez25coind fill it in.
