...
This document provides guidelines for internationalization of the EZ25COIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ez25coin_en.ts` remains unchanged.
