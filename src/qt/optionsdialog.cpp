    ...
    mapper(0)
{
    ...
    ui->ez25coinAtStartup->setToolTip(ui->ez25coinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->ez25coinAtStartup->setText(ui->ez25coinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openEZ25COINConfButton->setToolTip(ui->openEZ25COINConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new EZ25COINUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ez25coinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openEZ25COINConfButton_clicked()
{
