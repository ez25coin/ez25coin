...
#ifndef EZ25COIN_QT_EZ25COINUNITS_H
#define EZ25COIN_QT_EZ25COINUNITS_H
...
/** EZ25COIN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EZ25COINUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EZ25COINUnits(QObject *parent);

    /** EZ25COIN units.
      @note Source: https://en.ez25coin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EZC,
...
typedef EZ25COINUnits::Unit EZ25COINUnit;

#endif // EZ25COIN_QT_EZ25COINUNITS_H
