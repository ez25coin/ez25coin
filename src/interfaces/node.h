...
#ifndef EZ25COIN_INTERFACES_NODE_H
#define EZ25COIN_INTERFACES_NODE_H
...
//! Top-level interface for a ez25coin node (ez25coind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // EZ25COIN_INTERFACES_NODE_H
