 ...
 */
#ifndef EZ25COIN_UTIL_H
#define EZ25COIN_UTIL_H
...
extern const char * const EZ25COIN_CONF_FILENAME;
extern const char * const EZ25COIN_PID_FILENAME;
...
{
    std::string s = strprintf("ez25coin-%s", name);
