...
#ifndef EZ25COIN_WALLET_WALLET_H
#define EZ25COIN_WALLET_WALLET_H
...
public:
     ...
     * on this ez25coin node, and set to 0 for transactions that were created
...
#endif // EZ25COIN_WALLET_WALLET_H
