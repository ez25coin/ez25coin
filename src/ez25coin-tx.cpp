...
static void SetupEZ25COINTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ez25coin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ez25coin-tx [options] <hex-tx> [commands]  Update hex-encoded ez25coin transaction\n" +
            "or:     ez25coin-tx [options] -create [commands]   Create hex-encoded ez25coin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ez25coin transaction
