...
{
    BOOST_CHECK(TestSplitHost("www.ez25coincore.org", "www.ez25coincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.ez25coincore.org]", "www.ez25coincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.ez25coincore.org:80", "www.ez25coincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.ez25coincore.org]:80", "www.ez25coincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8152", "127.0.0.1", 8152));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8152", "127.0.0.1", 8152));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8152", "::ffff:127.0.0.1", 8152));
    BOOST_CHECK(TestSplitHost("[::]:8152", "::", 8152));
    BOOST_CHECK(TestSplitHost("::8152", "::8152", -1));
    BOOST_CHECK(TestSplitHost(":8152", "", 8152));
    BOOST_CHECK(TestSplitHost("[]:8152", "", 8152));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8152", "127.0.0.1:8152"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8152", "[::]:8152"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
